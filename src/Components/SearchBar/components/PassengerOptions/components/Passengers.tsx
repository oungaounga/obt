...
export default function Passengers(props) {
  ...
  return (
    <div
      className="relative flex-wrap flex justify-center gap-1 z-40"
      onClick={(e) => {
        e.stopPropagation()
        setTitle(makeTitle())
      }}
    >
      ...
      >
        <div
          id="personConfig"
          className="absolute select-none  top-[1.5rem] p-[1rem] w-[18rem] md:w-[22rem] bg-white rounded-xl text-black z-40 shadow-lg"
          ref={ref}
        >
